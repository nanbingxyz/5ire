          ...
          {collapsed ||
            (user && (
              <Button
                ...
                appearance="subtle"
                icon={
                  <Avatar aria-label={t("Common.User")} name={user.user_metadata.name} color="colorful" size={24} />
                }
              />
            ))}
        </div>
        <MenuPopover className="w-full" style={{ width: "254px" }}>
          <Button onClick={navToProfile} appearance="subtle" className="w-full justify-start">
            <div className="px-0 py-1.5">
              {user ? (
                ...
                <div className="flex justify-start flex-nowrap items-center">
                  <Avatar aria-label={t("Common.Guest")} className="mr-2" shape="square" size={40} />
